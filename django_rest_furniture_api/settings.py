...
# so that production will get the database info from environment variables
import os
# import environ
...
ALLOWED_HOSTS = [
    'localhost',
    'django-furniture-backup.herokuapp.com',
]
...
ROOT_URLCONF = 'django_rest_furniture_api.urls'
...
WSGI_APPLICATION = 'django_rest_furniture_api.wsgi.application'
